...
import 'package:simple_date/screen/details_page.dart';
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        return GestureDetector(
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => DetailsPage(user: users[index],)));
          },
          child: Stack(
            children: [
              Container(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        SizedBox(width: 10,),
                        Text('${users[index].age}', style: TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.w500),),
                      ],
                    ),
                    SizedBox(height: 10,),
                    Row(
